      ...
      <div className="container mx-auto px-6 lg:px-20">
        ...
        >
          <p className="text-lg text-center md:text-xl text-text-secondary leading-relaxed font-light">
            I'm a prefinal-year B.Tech student at{" "}
            <span className="text-accent-1 font-medium">LNCT Bhopal</span>{" "}
            (CSE · AI/ML), building scalable full-stack systems with the{" "}
            <span className="text-accent-1 font-medium">MERN stack</span> and
            integrating{" "}
            <span className="text-accent-1 font-medium">RAG & Generative AI</span>{" "}
            to make web products smarter. I hold a{" "}
            <span className="text-accent-1 font-medium">CGPA of 8.6</span>, have
            solved{" "}
            <span className="text-accent-1 font-medium">200+ DSA problems</span>{" "}
            across LeetCode & GFG, and am certified in{" "}
            <span className="text-accent-1 font-medium">Networking (Cisco)</span>{" "}
            and Java Backend Development. SIH 2025 participant —{" "}
            <span className="text-accent-1 font-medium">
              actively seeking internships and software engineering roles
            </span>
            .
          </p>
        </motion.div>
